  ...
  const faqs = [
    {
      ...
      answer: 'Create an account, verify your identity, and follow our simple pet listing process. Well guide you through each step.'
    },
    {
      question: 'What are the adoption fees?',
      answer: 'Adoption fees vary by pet and seller. Each listing includes transparent fee information and what it covers.'
    },
    {
      question: 'Is there a return policy?',
      answer: 'We work with adopters and sellers to ensure the best outcomes. Contact us within 14 days if you have concerns.'
    },
    {
      question: 'How do you verify sellers?',
      answer: 'We conduct thorough background checks, verify licenses, and regularly monitor seller activities to ensure safety.'
    }
  ];
          ...
          <div className="row justify-content-center text-center">
            <div className="col-lg-8">
              ...
              <p className={styles.heroText}>
                Have questions about adopting a pet or need support? 
                We're here to help make your pet journey amazing.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="accordion" id="faqAccordion">
                {faqs.map((faq, index) => (
                  <div key={index} className={`accordion-item ${styles.faqItem}`}>
